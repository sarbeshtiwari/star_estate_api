...
router.post('/addBrochure_Walkthrough/:projectname', brochureWalkthroughController.addBrochureWalkthrough);
...
router.put('/updateBrochure_Walkthrough/:id', brochureWalkthroughController.updateBrochureWalkthrough);
