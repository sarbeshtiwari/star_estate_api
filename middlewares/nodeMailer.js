...
const sendNRIQueryEmail = async (Name, Email, phoneNumber, user_query, utm_source, utm_medium, utm_campaign, utm_term, utm_content) => {

    const adminMailOptions = {
        from: 'sarbesh39tiwari@gmail.com',
        to: 'rahul8454454singh@gmail.com',
        subject: 'New NRI Query',
        text: `
            Dear Team,

            We have received a New NRI Query. Below are the details:
    ...
    <html>
    <head>
        <title>New NRI Query Received</title>
        <style>
            body {
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <strong>Dear Team,</strong>
                <p>We have received a New NRI query from a user. Below are the details:</p>
                <table>
                    <tr>
                        <th>Name</th>
                        <td>${Name}</td>
    ...
    try {
        ...
        console.log('Admin email sent successfully');
        await transporter.sendMail(userMailOptions);
        console.log('User email send succesfully');
    } catch (error) {
        console.error('Error sending email:', error);
    }
...
const sendChannelPartneremail = async (broker_name, company_name, registration_no, email, phoneNumber) => {

    const adminMailOptions = {
        from: 'sarbesh39tiwari@gmail.com',
    to: 'rahul8454454singh@gmail.com',
    subject: 'New Investor Application',
    text: `
        Dear Team,

        We have received a new Investor application. Below are the details:
    ...
    html: `
        ...
        <html>
        <head>
            <title>New Investor Application</title>
            <style>
                body {
                    margin: 0;
                    padding: 0;
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p><strong>Dear Team,</strong></p>
                    <p>We have received a New Investor application. Below are the details:</p>
                    <table>
                        <tr>
                            <td><strong>Name:</strong></td>
                            <td>${broker_name}</td>
    ...
    const userMailOptions = {
        ...
        text: `
                ...
                Thank you for showing intrest in Star Estate. We have received your application and will get back to you with further details shortly.
        ...
        html: `
            ...
            <body>
                <div class="container">
                    ...
                    <!-- Main Content -->
                    <div class="content">
                        <p>Dear <strong>${broker_name}</strong>,</p>
                        <p>Thank you for your interest in Star Estate. We have received your application and will get back to you with further details shortly.</p>
                        
                        <p>In the meantime, if you have any questions or require further information, feel free to contact us at <a href="mailto:info@starestate.in">info@starestate.in</a>.</p>
                        <p>Thank you again for showing intrest in us.</p>
                    </div>
...
module.exports = {sendQueryEmail, sendContactUsEmail, sendCareerEmail, sendNRIQueryEmail, sendChannelPartneremail};