...
// Configure storage for location advantage images
const storage = multer.diskStorage({
    destination: function (req, file, cb) {
        const uploadDir = 'star_estate/location_advantages'; // Define your upload directory
...
// Create multer upload instance for location advantage images
