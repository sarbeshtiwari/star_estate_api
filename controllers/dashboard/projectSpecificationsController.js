const UserModel = require('../../models/dashboard/projectSpecificationsModel');

// Add Project Specifications
exports.addProjectSpecificationsByProjectName = async (req, res) => {
...
exports.getProjectSpecificationsByProjectName = async (req, res) => {
    const { id } = req.params;
